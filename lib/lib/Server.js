  ...
  _createClass(Server, [{
    ...
    value: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(ctx, next) {
        var _router$match, _router$match$action, action, _router$match$paras, paras, _action$middleware, middleware, _action$act, act, params, startTime, endTime;

        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _router$match = this.router.match(ctx.request.url, ctx.request.method.toLocaleLowerCase()), _router$match$action = _router$match.action, action = _router$match$action === undefined ? {} : _router$match$action, _router$match$paras = _router$match.paras, paras = _router$match$paras === undefined ? {} : _router$match$paras;
                _action$middleware = action.middleware, middleware = _action$middleware === undefined ? [] : _action$middleware, _action$act = action.act, act = _action$act === undefined ? function () {} : _action$act;
